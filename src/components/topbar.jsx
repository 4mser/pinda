...
const Topbar = () => {
  ...
  return (
    <section className="w-full">
      ...
      <div className="z-50 fixed w-full top-12 left-0  bg-gradient-to-b from-white to-transparent flex justify-between px-4 py-2 md:px-10 md:gap-10 md:justify-start items-center border-b border-black/10 md:border-none md:py-10">
