export const productos = {
    kombuchas: [
        ...
        },
        {
            ...
            imagenModal:"/posts/6.jpeg",
            bg:"bg-gradient-to-br from-lime-100 to-yellow-200"
        },
        {
            nombre: "Maqui Cacao",
            precio: "1.990",
            imagen: "/images/pindas/pinda_maqui_cacao.png",
            imagenModal:"/posts/5.jpeg",
        ...
        },
        {
            ...
            imagenModal:"/posts/4.jpeg",
            bg:"bg-gradient-to-br from-pink-100 to-red-200"
        }
    ],
    packs: [
        {
